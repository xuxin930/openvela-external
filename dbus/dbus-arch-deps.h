...
#define DBUS_INT64_MODIFIER PRIi64

#define DBUS_INT64_CONSTANT(val)  (INT64_C(val))
#define DBUS_UINT64_CONSTANT(val) (UINT64_C(val))
...
#define DBUS_VERSION_STRING "1.15.1"

#define DBUS_VERSION ((1 << 16) | (15 << 8) | (1))
