...
/* Define to 1 if you have the `strtobytes' function. */
/* #undef HAVE_STRTOBYTES */
...
/* Retry delay for sending to remote syslog servers, default: 180 */
/* #undef INET_SUSPEND_TIME */

/* Define to the sub-directory where libtool stores uninstalled libraries. */
#define LT_OBJDIR ".libs/"

/* Name of package */
#define PACKAGE "sysklogd"
